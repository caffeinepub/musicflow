...
export class Backend implements backendInterface {
    ...
    async getLyrics(arg0: bigint): Promise<Array<LyricLine>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLyrics(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlayCount(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopPlayed(): Promise<Array<Song>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopPlayed();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalSecondsListened(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalSecondsListened();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordPlay(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordPlay(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
